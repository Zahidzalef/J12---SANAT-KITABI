package com.zahidiyigokler.a5sanatkitab;
...
import com.zahidiyigokler.a5sanatkitab.databinding.ActivityDetailsBinding;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.matches("new")) {
            ...
            Bitmap selectImage = BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.k);
            ...
            try {
                ...
                int artNameIx = ((Cursor) cursor).getColumnIndex("artname");
    ...
    public void selectImage(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.DYNAMIC_RECEIVER_NOT_EXPORTED_PERMISSION) != PERMISSION_GRANTED) {
